...
/**
 * Resolve the /24 base ("192.168.1.") from an IP-ish string such as
 * "192.168.1.5:80" or "192.168.1.5". Returns null when no IPv4 is present.
 * @param {string} addr
 * @returns {string|null}
 */
 ...
 *
 * @param {object}   opts
 * @param {string}   opts.subnetBase  e.g. "192.168.1." (1–254 is appended)
