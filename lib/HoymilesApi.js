...
class HoymilesApi {
  ...
  /**
   * Set the max charge/discharge power limit (%) on a mode that supports it.
   * Targets the active mode if it's a Max-Power mode (5/6); otherwise applies
   * to and activates Self-Consumption + Max Power (5).
   */
